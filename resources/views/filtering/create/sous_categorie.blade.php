                        ...
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <div class="input-group input-group-sm" style="width: 150px;">
                                    <input type="text" id="search_souscategory" name="souscategory" class="form-control float-right"
                                        placeholder="Search">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#search_souscategory').on('keyup', function() {
                ...
                var url = 'http://192.168.137.187:8000/backoffice/search/soucategory'
