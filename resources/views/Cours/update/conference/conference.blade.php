  ...
  <div class="tab-pane" id="timeline">
      ...
      <!-- /.card-header -->
      <form action="{{ Route('dashboard.update.conference') }}" method="post">
          @method('patch')
          @csrf
          ...
          <div class="card-body">
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control"
                      value="{{ implode(',', $Cour->tags) }}" 
                      name="tags[]" id="tags-input" />
                      ...
                      <div class="col-md-4">
                          ...
                          <div class="form-group">
                              ...
                              <input type="time" class="form-control" value="" id="coursDuration"
                                  name="coursDuration" value="{{ $coursCoference->duration }}" step="1">
                          </div>
